    ...
    let fw  = {
        ...
        reconocer: function(callback) {
            recognition.onresult = function(event) {
                ...
                if(speechToText == 'listar usuarios' ||speechToText == 'dime los usuarios')
                    fw.listarUsuarios();
                else
                    callback(event);
            };
        ...
        listarUsuarios: function() {
            axios.get('/wp-json/wp/v2/users', axiosConfig)
            .then(function (response)
            {
                ...
                for(var index in response.data)
                {
                    ...
                    respuesta = respuesta + response.data[index].name + ', ';
                }

                fw.hablar('Los usuarios creados en el wordpress, son:' + respuesta);
            })
